  ...
  return (
    <div>
      ...
      <div className="border rounded-xl my-8">
        ...
        <div className="flex p-4 justify-end">
        <div className="flex">
        <img src={menu2} alt="img" className="object-contain h-12" />
        <img src={menu1} alt="img" className="object-contain h-12" />
        <img src={switc} alt="img" className="object-contain h-12" />
      ...
      <div className="border rounded-xl my-8">
        ...
        <div className="flex p-4 col-span-2">
          ...
          <div className="mx-2 w-70">
            <p className="font-semibold text-xl text-gray-900">
            Filter harmful content on Device  <button
            type="button"
            class="text-gray-900 gap-2 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-3 py-1 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2"
          >
            <AiFillEdit />
            ...
            <span class="bg-blue-100 text-slate-900 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">Self-harm</span>
            <span class="bg-blue-100 text-slate-900 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">Bullying/Harassment</span>
            <span class="bg-[#172A6E] text-white text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">+25 More Tags</span>
            </div>
          </div>
        </div>
        <div className="flex p-4 mt-4 justify-end">
        <div >
        <img src={safemode} alt="img" className="object-contain h-12" />
