...
const Search = ({ className = " ", onClick, placeholder }) => {
  return (
    <div className="flex  shadow-[0px_0px_56px_0px_#00000014]    flex-row   rounded-[8px]  cursor-pointer  py-[10px] ps-[16px]  pe-[130px]   sm:pe-[140px]   items-center  border-[1px] border-[#D0D5DD]  ">
