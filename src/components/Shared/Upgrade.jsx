  ...
  return (
    <div className=" md:w-[28rem] w-[22rem]">
      ...
      <div className="mt-3 flex flex-row  px-[16px] pb-[12px] ">
        <Button className="py-[10px] px-4 md:px-[32px] text-[18px] font-[600] text-[#000000] " onClick={onCloseModal}>
           Cancel
        </Button>
       <div className="ms-3">
        <Button className="py-[10px] bg-green-100  border-green-500 border-[1px] font-[600] px-[35px] md:px-[70px] text-[18px] text-[#000000] " >
