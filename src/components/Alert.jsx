...
<GoAlert />
  ...
  This demo dashboard is for reference only, no activities can be performed here. <a href="#" className="font-semibold underline hover:no-underline text-[#172A6E]">Upgrade to Unlock Full Access.</a>
  </div>
